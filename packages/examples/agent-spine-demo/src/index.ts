...
export interface Config {
  ...
  /** Retries after a normal stop contains only reasoning. */
  reasoningOnlyStopRetries?: AgentLoopConfig['reasoningOnlyStopRetries']
...
export function pickSpineConfig(config: Omit<Config, 'agents'>): Omit<Config, 'agents'> {
  return {
    ...
    ...config.reasoningOnlyStopRetries !== undefined ? { reasoningOnlyStopRetries: config.reasoningOnlyStopRetries } : {},
