...
import workspaceFileViewerRemote from '@deepseek-ai/dsh-host-workspace-file-viewer/remote'
...
export type {} from '@deepseek-ai/dsh-host-workspace-file-viewer/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, workspaceFileViewerRemote, messageFeedbackRemote,
    ]) {
